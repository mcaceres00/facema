...
<head>
	...
	<meta name="description" content="Facema es un sistema de ventas que le permite llevar el control de todo lo relacionado a su negocio.">
	<title>Facema Sistema de compras ventas</title>
