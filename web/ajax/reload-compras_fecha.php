<?php 
	...
	$count_compras = $objCompra->Count_Compras('FECHAS',$fecha1,$fecha2);
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php 
										$filas = $objCompra->Listar_Compras('FECHAS',$fecha1,$fecha2,1,''); 
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php 
										$filas = $objCompra->Listar_Compras('FECHAS',$fecha1,$fecha2,0,''); 
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column) 
										{
						...
						<div class="panel-body">
							<table class="table datatable-basic table-xs table-hover">
								...
								<tbody>
								  ...
								  <?php 
										$filas = $objCompra->Listar_Compras('FECHAS',$fecha1,$fecha2,'',2); 
										if (is_array($filas) || is_object($filas))
										{
										foreach ($filas as $row => $column) 
										{
