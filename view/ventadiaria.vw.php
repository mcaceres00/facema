				...
				<div class="col-lg-12">
					<div class="panel panel-flat">
						...
						<div class="panel-heading">
							<h6 class="panel-title">Ventas del Día - <?php echo
							...
							<div class="tabbable">
								...
								<div class="tab-content">
									...
									<div class="tab-pane" id="label-tab4">
										...
										<div class="panel panel-flat">
											<div class="panel-heading">
												<h5 class="panel-title">Ventas al Crédito</h5>
												<div class="heading-elements">
										...
										<div class="panel-body">
											<div class="table-responsive">
												<table class="table table-xxs table-bordered">
												 ...
												 <tr>
												 	<td width="5%" class="text-bold text-left">Nº. VENTA</td>
													<td width="35%"></td>
												...
												<tr>
													<td width="20%" class="text-bold text-left">Nº. COMPROBANTE</td>
													<td width="5%"></td>
