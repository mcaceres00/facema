			...
			<div class="panel panel-flat">
				<div class="breadcrumb-line">
					<ul class="breadcrumb">
						...
						<li class="active">Presentaciones de Productos</li>
					</ul>
				</div>
					<div class="panel-heading">
						<h5 class="panel-title">Presentaciones de Productos</h5>
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												...
												<input type="text" id="txtPresentacion" name="txtPresentacion" placeholder="EJ. 1 LIBRA"
									...
									<div class="form-group">
										<div class="row">
											<div class="col-sm-8">
												...
												<input type="text" id="txtSigla" name="txtSigla" placeholder="EJ. 1 LB"
												 class="form-control" style="text-transform:uppercase;"
                                        		onkeyup="javascript:this.value=this.value.toUpperCase();">
											</div>
										</div>
